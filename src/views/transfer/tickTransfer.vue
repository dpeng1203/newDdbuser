<template>
  <div class="transfer">
    ...
    <div class="btn">
      ...
      <div class="btn-right" @click="$router.push('/transferRecord')">
        转移记录
      </div>
    </div>

    <van-popup v-model="showKeyboard" position="top">
      <div class="pw-box">
        <input
          type="password"
          pattern="[0-9]*"
          ...
          class="pw"
        />
        <van-button type="primary" class="btn-pw" @click="refundPw"
          >确认</van-button
        >
      </div>
    </van-popup>
