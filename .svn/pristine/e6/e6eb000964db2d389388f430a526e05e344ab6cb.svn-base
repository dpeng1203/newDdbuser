                    ...
                    wx.ready( () => {
                        ...
                        if(this.actNum == 1) {
                            wx.onMenuShareAppMessage({
                                title: '【DODO养生仪】您的好友赠送您两张体验券',                                                            // 分享标题
                                link: 'http://web2.dodohz.com/ddbxryuser/index.html?#/getTicket?memCode=' + localStorage.memId,             // 分享链接
                                desc: '“DODO智能养生仪”黑科技，追循古法，智慧养生！',                                                       // 分享描述
                                imgUrl: require('../../assets/img/shareLogo.jpg'),                                                           // 分享图
                                success () {
                                    // Toast('分享成功！')
                            ...
                            wx.onMenuShareAppMessage({
                                ...
                                link: 'http://web2.dodohz.com/ddbxryuser/index.html?#/joinAct?act=2',             // 分享链接
                            ...
                            wx.onMenuShareAppMessage({
                                title: '【百日行动派礼】',                                                             // 分享标题
                                link: 'http://web2.dodohz.com/ddbxryuser/index.html?#/joinAct?act=3',             // 分享链接
                            ...
                            wx.onMenuShareAppMessage({
                                title: '【百日行动派】',                                                             // 分享标题
                                link: 'http://web2.dodohz.com/ddbxryuser/index.html?#/joinAct?act=4',             // 分享链接
