<template>
  <div class="home">
        <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white">
            <van-swipe-item><img src="../../assets/img/swipe_1.jpg" alt=""></van-swipe-item>
            <van-swipe-item><img src="../../assets/img/swipe_2.jpg" alt=""></van-swipe-item>
            <van-swipe-item><img src="../../assets/img/swipe_3.jpg" alt=""></van-swipe-item>
        </van-swipe>
        <div class="list">
